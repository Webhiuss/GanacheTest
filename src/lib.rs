...
#[derive(Debug)]
pub struct GanacheTestProcessor {
    verbose: bool,
    processed_count: usize,
}

impl GanacheTestProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting GanacheTest processing");
    
    let mut processor = GanacheTestProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = GanacheTestProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = GanacheTestProcessor::new(false);
